...
subroutine getfc(sinth,costh,Ncoeff,fitted_fc_coeff,stride_arr,fn_order,n_params,DesMat,fc)
	implicit none 
    integer::ii
...
subroutine getdfc(sinth,costh,Ncoeff,fitted_fc_coeff,stride_arr,fn_order,n_params,DDesMat,dfc)
	implicit none 
    integer::ii
	integer,intent(in)::n_params ,fn_order,Ncoeff(0:4),stride_arr(0:fn_order-1,0:2)
...
subroutine  getAllDfc(sinth,costh,dfc_quad_es,dfc_quad_os,dfc_quad_ea,dfc_quad_oa,dfc_qubic_es_gt5,dfc_qubic_es_lt5,dfc_qubic_es_lt2,dfc_qubic_ea_gt5,dfc_qubic_ea_lt5,dfc_qubic_ea_lt2,dfc_qubic_os_gt5,dfc_qubic_os_lt5,dfc_qubic_os_lt2,dfc_qubic_oa_gt5,dfc_qubic_oa_lt5,dfc_qubic_oa_lt2,dfc_quartic_es_gt5,dfc_quartic_es_lt5,dfc_quartic_es_lt2,dfc_quartic_ea_gt5,dfc_quartic_ea_lt5,dfc_quartic_ea_lt2,dfc_quartic_os_gt5,dfc_quartic_os_lt5,dfc_quartic_os_lt2,dfc_quartic_oa_gt5,dfc_quartic_oa_lt5,dfc_quartic_oa_lt2,dfc_qo_es,dfc_qo_ea,dfc_qo_os,dfc_qo_oa,DDMES_quad,DDMES_gt5,DDMES_qo,DDMES_lt2,DDMEA_quad,DDMEA_gt5,DDMEA_qo,DDMEA_lt2,DDMOS_quad,DDMOS_gt5,DDMOS_qo,DDMOS_lt2,DDMOA_quad,DDMOA_gt5,DDMOA_qo,DDMOA_lt2) 
    ...
    !For quadratic
    !ES
	call getdfc(sinth,costh,Ncoeff_quad_es,fitted_fc_coeff_quad_es,stride_arr_quad_es,fn_order_quad_es,n_fcs_quad_es,DDMES_quad,dfc_quad_es)
    !EA
	call getdfc(sinth,costh,Ncoeff_quad_ea,fitted_fc_coeff_quad_ea,stride_arr_quad_ea,fn_order_quad_ea,n_fcs_quad_ea,DDMEA_quad,dfc_quad_ea)
    !OS
    call getdfc(sinth,costh,Ncoeff_quad_os,fitted_fc_coeff_quad_os,stride_arr_quad_os,fn_order_quad_os,n_fcs_quad_os,DDMOS_quad,dfc_quad_os)
    !OA
    call getdfc(sinth,costh,Ncoeff_quad_oa,fitted_fc_coeff_quad_oa,stride_arr_quad_oa,fn_order_quad_oa,n_fcs_quad_oa,DDMOA_quad,dfc_quad_oa)
   	 
    !For qubic
    !ES
    call getdfc(sinth,costh,Ncoeff_qubic_es_gt5,fitted_fc_coeff_qubic_es_gt5,stride_arr_qubic_es_gt5,fn_order_qubic_es_gt5,n_fcs_qubic_es_gt5,DDMES_gt5,dfc_qubic_es_gt5)
   	call getdfc(sinth,costh,Ncoeff_qubic_es_lt5,fitted_fc_coeff_qubic_es_lt5,stride_arr_qubic_es_lt5,fn_order_qubic_es_lt5,n_fcs_qubic_es_lt5,DDMES_gt5,dfc_qubic_es_lt5)
    call getdfc(sinth,costh,Ncoeff_qubic_es_lt2,fitted_fc_coeff_qubic_es_lt2,stride_arr_qubic_es_lt2,fn_order_qubic_es_lt2,n_fcs_qubic_es_lt2,DDMES_lt2,dfc_qubic_es_lt2)

    !EA
    call getdfc(sinth,costh,Ncoeff_qubic_ea_gt5,fitted_fc_coeff_qubic_ea_gt5,stride_arr_qubic_ea_gt5,fn_order_qubic_ea_gt5,n_fcs_qubic_ea_gt5,DDMEA_gt5,dfc_qubic_ea_gt5)
   	call getdfc(sinth,costh,Ncoeff_qubic_ea_lt5,fitted_fc_coeff_qubic_ea_lt5,stride_arr_qubic_ea_lt5,fn_order_qubic_ea_lt5,n_fcs_qubic_ea_lt5,DDMEA_gt5,dfc_qubic_ea_lt5)
    call getdfc(sinth,costh,Ncoeff_qubic_ea_lt2,fitted_fc_coeff_qubic_ea_lt2,stride_arr_qubic_ea_lt2,fn_order_qubic_ea_lt2,n_fcs_qubic_ea_lt2,DDMEA_lt2,dfc_qubic_ea_lt2)
    
    !OS
    call getdfc(sinth,costh,Ncoeff_qubic_os_gt5,fitted_fc_coeff_qubic_os_gt5,stride_arr_qubic_os_gt5,fn_order_qubic_os_gt5,n_fcs_qubic_os_gt5,DDMOS_gt5,dfc_qubic_os_gt5)
    call getdfc(sinth,costh,Ncoeff_qubic_os_lt5,fitted_fc_coeff_qubic_os_lt5,stride_arr_qubic_os_lt5,fn_order_qubic_os_lt5,n_fcs_qubic_os_lt5,DDMOS_gt5,dfc_qubic_os_lt5)
    call getdfc(sinth,costh,Ncoeff_qubic_os_lt2,fitted_fc_coeff_qubic_os_lt2,stride_arr_qubic_os_lt2,fn_order_qubic_os_lt2,n_fcs_qubic_os_lt2,DDMOS_lt2,dfc_qubic_os_lt2)
    
    !OA
    call getdfc(sinth,costh,Ncoeff_qubic_oa_gt5,fitted_fc_coeff_qubic_oa_gt5,stride_arr_qubic_oa_gt5,fn_order_qubic_oa_gt5,n_fcs_qubic_oa_gt5,DDMOA_gt5,dfc_qubic_oa_gt5)
    call getdfc(sinth,costh,Ncoeff_qubic_oa_lt5,fitted_fc_coeff_qubic_oa_lt5,stride_arr_qubic_oa_lt5,fn_order_qubic_oa_lt5,n_fcs_qubic_oa_lt5,DDMOA_gt5,dfc_qubic_oa_lt5)
    call getdfc(sinth,costh,Ncoeff_qubic_oa_lt2,fitted_fc_coeff_qubic_oa_lt2,stride_arr_qubic_oa_lt2,fn_order_qubic_oa_lt2,n_fcs_qubic_oa_lt2,DDMOA_lt2,dfc_qubic_oa_lt2)
    
    !For quartic
    !ES
    call getdfc(sinth,costh,Ncoeff_quartic_es_gt5,fitted_fc_coeff_quartic_es_gt5,stride_arr_quartic_es_gt5,fn_order_quartic_es_gt5,n_fcs_quartic_es_gt5,DDMES_gt5,dfc_quartic_es_gt5)
    call getdfc(sinth,costh,Ncoeff_quartic_es_lt5,fitted_fc_coeff_quartic_es_lt5,stride_arr_quartic_es_lt5,fn_order_quartic_es_lt5,n_fcs_quartic_es_lt5,DDMES_gt5,dfc_quartic_es_lt5)
    call getdfc(sinth,costh,Ncoeff_quartic_es_lt2,fitted_fc_coeff_quartic_es_lt2,stride_arr_quartic_es_lt2,fn_order_quartic_es_lt2,n_fcs_quartic_es_lt2,DDMES_lt2,dfc_quartic_es_lt2)
    
    !EA
    call getdfc(sinth,costh,Ncoeff_quartic_ea_gt5,fitted_fc_coeff_quartic_ea_gt5,stride_arr_quartic_ea_gt5,fn_order_quartic_ea_gt5,n_fcs_quartic_ea_gt5,DDMEA_gt5,dfc_quartic_ea_gt5)
    call getdfc(sinth,costh,Ncoeff_quartic_ea_lt5,fitted_fc_coeff_quartic_ea_lt5,stride_arr_quartic_ea_lt5,fn_order_quartic_ea_lt5,n_fcs_quartic_ea_lt5,DDMEA_gt5,dfc_quartic_ea_lt5)
    call getdfc(sinth,costh,Ncoeff_quartic_ea_lt2,fitted_fc_coeff_quartic_ea_lt2,stride_arr_quartic_ea_lt2,fn_order_quartic_ea_lt2,n_fcs_quartic_ea_lt2,DDMEA_lt2,dfc_quartic_ea_lt2)
    
    !OS
    call getdfc(sinth,costh,Ncoeff_quartic_os_gt5,fitted_fc_coeff_quartic_os_gt5,stride_arr_quartic_os_gt5,fn_order_quartic_os_gt5,n_fcs_quartic_os_gt5,DDMOS_gt5,dfc_quartic_os_gt5)
    call getdfc(sinth,costh,Ncoeff_quartic_os_lt5,fitted_fc_coeff_quartic_os_lt5,stride_arr_quartic_os_lt5,fn_order_quartic_os_lt5,n_fcs_quartic_os_lt5,DDMOS_gt5,dfc_quartic_os_lt5)
    call getdfc(sinth,costh,Ncoeff_quartic_os_lt2,fitted_fc_coeff_quartic_os_lt2,stride_arr_quartic_os_lt2,fn_order_quartic_os_lt2,n_fcs_quartic_os_lt2,DDMOS_lt2,dfc_quartic_os_lt2)

    !OA
    call getdfc(sinth,costh,Ncoeff_quartic_oa_gt5,fitted_fc_coeff_quartic_oa_gt5,stride_arr_quartic_oa_gt5,fn_order_quartic_oa_gt5,n_fcs_quartic_oa_gt5,DDMOA_gt5,dfc_quartic_oa_gt5)
    call getdfc(sinth,costh,Ncoeff_quartic_oa_lt5,fitted_fc_coeff_quartic_oa_lt5,stride_arr_quartic_oa_lt5,fn_order_quartic_oa_lt5,n_fcs_quartic_oa_lt5,DDMOA_gt5,dfc_quartic_oa_lt5)
    call getdfc(sinth,costh,Ncoeff_quartic_oa_lt2,fitted_fc_coeff_quartic_oa_lt2,stride_arr_quartic_oa_lt2,fn_order_quartic_oa_lt2,n_fcs_quartic_oa_lt2,DDMOA_lt2,dfc_quartic_oa_lt2)
	!QO terms
    call getdfc(sinth,costh,Ncoeff_qo_es,fitted_fc_coeff_qo_es,stride_arr_qo_es,fn_order_qo_es,n_fcs_qo_es,DDMES_qo,dfc_qo_es)
    call getdfc(sinth,costh,Ncoeff_qo_ea,fitted_fc_coeff_qo_ea,stride_arr_qo_ea,fn_order_qo_ea,n_fcs_qo_ea,DDMEA_qo,dfc_qo_ea)
    call getdfc(sinth,costh,Ncoeff_qo_os,fitted_fc_coeff_qo_os,stride_arr_qo_os,fn_order_qo_os,n_fcs_qo_os,DDMOS_qo,dfc_qo_os)
    call getdfc(sinth,costh,Ncoeff_qo_oa,fitted_fc_coeff_qo_oa,stride_arr_qo_oa,fn_order_qo_oa,n_fcs_qo_oa,DDMOA_qo,dfc_qo_oa)
endsubroutine
!****************************************************************************************************************************************************#
subroutine getAllfc(sinth,costh,fc_quad_es,fc_quad_os,fc_quad_ea,fc_quad_oa,fc_qubic_es_gt5,fc_qubic_es_lt5,fc_qubic_es_lt2,fc_qubic_ea_gt5,fc_qubic_ea_lt5,fc_qubic_ea_lt2,fc_qubic_os_gt5,fc_qubic_os_lt5,fc_qubic_os_lt2,fc_qubic_oa_gt5,fc_qubic_oa_lt5,fc_qubic_oa_lt2,fc_quartic_es_gt5,fc_quartic_es_lt5,fc_quartic_es_lt2,fc_quartic_es_ltpt1,fc_quartic_ea_gt5,fc_quartic_ea_lt5,fc_quartic_ea_lt2,fc_quartic_ea_ltpt1, fc_quartic_os_gt5,fc_quartic_os_lt5,fc_quartic_os_lt2,fc_quartic_os_ltpt1,fc_quartic_oa_gt5,fc_quartic_oa_lt5,fc_quartic_oa_lt2,fc_quartic_oa_ltpt1,fc_qo_es,fc_qo_ea,fc_qo_os,fc_qo_oa,DMES_quad,DMES_gt5,DMES_qo,DMES_lt2,DMEA_quad,DMEA_gt5,DMEA_qo,DMEA_lt2,DMOS_quad,DMOS_gt5,DMOS_qo,DMOS_lt2,DMOA_quad,DMOA_gt5,DMOA_qo,DMOA_lt2) 
	implicit none 
	real(8),intent(in)::sinth(0:n_fix_tors-1,0:max_id(0)),costh(0:n_fix_tors-1,0:max_id(0)) 
    ...
    !For quadratic
    !ES
    call getfc(sinth,costh,Ncoeff_quad_es,fitted_fc_coeff_quad_es,stride_arr_quad_es,fn_order_quad_es,n_fcs_quad_es,DMES_quad,fc_quad_es)
    !EA                                                                                                                   
    call getfc(sinth,costh,Ncoeff_quad_ea,fitted_fc_coeff_quad_ea,stride_arr_quad_ea,fn_order_quad_ea,n_fcs_quad_ea,DMEA_quad,fc_quad_ea)
    !OS                                                                                                                   
    call getfc(sinth,costh,Ncoeff_quad_os,fitted_fc_coeff_quad_os,stride_arr_quad_os,fn_order_quad_os,n_fcs_quad_os,DMOS_quad,fc_quad_os)
    !OA                                                                                                                   
    call getfc(sinth,costh,Ncoeff_quad_oa,fitted_fc_coeff_quad_oa,stride_arr_quad_oa,fn_order_quad_oa,n_fcs_quad_oa,DMOA_quad,fc_quad_oa)
    
    !For qubic
    !ES
    call getfc(sinth,costh,Ncoeff_qubic_es_gt5,fitted_fc_coeff_qubic_es_gt5,stride_arr_qubic_es_gt5,fn_order_qubic_es_gt5,n_fcs_qubic_es_gt5,DMES_gt5,fc_qubic_es_gt5)
   	call getfc(sinth,costh,Ncoeff_qubic_es_lt5,fitted_fc_coeff_qubic_es_lt5,stride_arr_qubic_es_lt5,fn_order_qubic_es_lt5,n_fcs_qubic_es_lt5,DMES_gt5,fc_qubic_es_lt5)
    call getfc(sinth,costh,Ncoeff_qubic_es_lt2,fitted_fc_coeff_qubic_es_lt2,stride_arr_qubic_es_lt2,fn_order_qubic_es_lt2,n_fcs_qubic_es_lt2,DMES_lt2,fc_qubic_es_lt2)
    
    !EA
    call getfc(sinth,costh,Ncoeff_qubic_ea_gt5,fitted_fc_coeff_qubic_ea_gt5,stride_arr_qubic_ea_gt5,fn_order_qubic_ea_gt5,n_fcs_qubic_ea_gt5,DMEA_gt5,fc_qubic_ea_gt5)
   	call getfc(sinth,costh,Ncoeff_qubic_ea_lt5,fitted_fc_coeff_qubic_ea_lt5,stride_arr_qubic_ea_lt5,fn_order_qubic_ea_lt5,n_fcs_qubic_ea_lt5,DMEA_gt5,fc_qubic_ea_lt5)
    call getfc(sinth,costh,Ncoeff_qubic_ea_lt2,fitted_fc_coeff_qubic_ea_lt2,stride_arr_qubic_ea_lt2,fn_order_qubic_ea_lt2,n_fcs_qubic_ea_lt2,DMEA_lt2,fc_qubic_ea_lt2)
    
    !OS
    call getfc(sinth,costh,Ncoeff_qubic_os_gt5,fitted_fc_coeff_qubic_os_gt5,stride_arr_qubic_os_gt5,fn_order_qubic_os_gt5,n_fcs_qubic_os_gt5,DMOS_gt5,fc_qubic_os_gt5)
    call getfc(sinth,costh,Ncoeff_qubic_os_lt5,fitted_fc_coeff_qubic_os_lt5,stride_arr_qubic_os_lt5,fn_order_qubic_os_lt5,n_fcs_qubic_os_lt5,DMOS_gt5,fc_qubic_os_lt5)
    call getfc(sinth,costh,Ncoeff_qubic_os_lt2,fitted_fc_coeff_qubic_os_lt2,stride_arr_qubic_os_lt2,fn_order_qubic_os_lt2,n_fcs_qubic_os_lt2,DMOS_lt2,fc_qubic_os_lt2)
    
    !OA
    call getfc(sinth,costh,Ncoeff_qubic_oa_gt5,fitted_fc_coeff_qubic_oa_gt5,stride_arr_qubic_oa_gt5,fn_order_qubic_oa_gt5,n_fcs_qubic_oa_gt5,DMOA_gt5,fc_qubic_oa_gt5)
    call getfc(sinth,costh,Ncoeff_qubic_oa_lt5,fitted_fc_coeff_qubic_oa_lt5,stride_arr_qubic_oa_lt5,fn_order_qubic_oa_lt5,n_fcs_qubic_oa_lt5,DMOA_gt5,fc_qubic_oa_lt5)
    call getfc(sinth,costh,Ncoeff_qubic_oa_lt2,fitted_fc_coeff_qubic_oa_lt2,stride_arr_qubic_oa_lt2,fn_order_qubic_oa_lt2,n_fcs_qubic_oa_lt2,DMOA_lt2,fc_qubic_oa_lt2)
    
    !For quartic
    !ES
    call getfc(sinth,costh,Ncoeff_quartic_es_gt5,fitted_fc_coeff_quartic_es_gt5,stride_arr_quartic_es_gt5,fn_order_quartic_es_gt5,n_fcs_quartic_es_gt5,DMES_gt5,fc_quartic_es_gt5)
    call getfc(sinth,costh,Ncoeff_quartic_es_lt5,fitted_fc_coeff_quartic_es_lt5,stride_arr_quartic_es_lt5,fn_order_quartic_es_lt5,n_fcs_quartic_es_lt5,DMES_gt5,fc_quartic_es_lt5)
    call getfc(sinth,costh,Ncoeff_quartic_es_lt2,fitted_fc_coeff_quartic_es_lt2,stride_arr_quartic_es_lt2,fn_order_quartic_es_lt2,n_fcs_quartic_es_lt2,DMES_lt2,fc_quartic_es_lt2)
	fc_quartic_es_ltpt1 = fitted_fc_coeff_quartic_es_ltpt1
    !EA
    call getfc(sinth,costh,Ncoeff_quartic_ea_gt5,fitted_fc_coeff_quartic_ea_gt5,stride_arr_quartic_ea_gt5,fn_order_quartic_ea_gt5,n_fcs_quartic_ea_gt5,DMEA_gt5,fc_quartic_ea_gt5)
    call getfc(sinth,costh,Ncoeff_quartic_ea_lt5,fitted_fc_coeff_quartic_ea_lt5,stride_arr_quartic_ea_lt5,fn_order_quartic_ea_lt5,n_fcs_quartic_ea_lt5,DMEA_gt5,fc_quartic_ea_lt5)
    call getfc(sinth,costh,Ncoeff_quartic_ea_lt2,fitted_fc_coeff_quartic_ea_lt2,stride_arr_quartic_ea_lt2,fn_order_quartic_ea_lt2,n_fcs_quartic_ea_lt2,DMEA_lt2,fc_quartic_ea_lt2)
	fc_quartic_ea_ltpt1 = fitted_fc_coeff_quartic_ea_ltpt1
    
    !OS
    call getfc(sinth,costh,Ncoeff_quartic_os_gt5,fitted_fc_coeff_quartic_os_gt5,stride_arr_quartic_os_gt5,fn_order_quartic_os_gt5,n_fcs_quartic_os_gt5,DMOS_gt5,fc_quartic_os_gt5)
    call getfc(sinth,costh,Ncoeff_quartic_os_lt5,fitted_fc_coeff_quartic_os_lt5,stride_arr_quartic_os_lt5,fn_order_quartic_os_lt5,n_fcs_quartic_os_lt5,DMOS_gt5,fc_quartic_os_lt5)
    call getfc(sinth,costh,Ncoeff_quartic_os_lt2,fitted_fc_coeff_quartic_os_lt2,stride_arr_quartic_os_lt2,fn_order_quartic_os_lt2,n_fcs_quartic_os_lt2,DMOS_lt2,fc_quartic_os_lt2)
	fc_quartic_os_ltpt1 = fitted_fc_coeff_quartic_os_ltpt1
    !OA
    call getfc(sinth,costh,Ncoeff_quartic_oa_gt5,fitted_fc_coeff_quartic_oa_gt5,stride_arr_quartic_oa_gt5,fn_order_quartic_oa_gt5,n_fcs_quartic_oa_gt5,DMOA_gt5,fc_quartic_oa_gt5)
    call getfc(sinth,costh,Ncoeff_quartic_oa_lt5,fitted_fc_coeff_quartic_oa_lt5,stride_arr_quartic_oa_lt5,fn_order_quartic_oa_lt5,n_fcs_quartic_oa_lt5,DMOA_gt5,fc_quartic_oa_lt5)
    call getfc(sinth,costh,Ncoeff_quartic_oa_lt2,fitted_fc_coeff_quartic_oa_lt2,stride_arr_quartic_oa_lt2,fn_order_quartic_oa_lt2,n_fcs_quartic_oa_lt2,DMOA_lt2,fc_quartic_oa_lt2)
	fc_quartic_oa_ltpt1 = fitted_fc_coeff_quartic_oa_ltpt1
  	!QO
	call getfc(sinth,costh,Ncoeff_qo_es,fitted_fc_coeff_qo_es,stride_arr_qo_es,fn_order_qo_es,n_fcs_qo_es,DMES_qo,fc_qo_es)
	call getfc(sinth,costh,Ncoeff_qo_ea,fitted_fc_coeff_qo_ea,stride_arr_qo_ea,fn_order_qo_ea,n_fcs_qo_ea,DMEA_qo,fc_qo_ea)
	call getfc(sinth,costh,Ncoeff_qo_os,fitted_fc_coeff_qo_os,stride_arr_qo_os,fn_order_qo_os,n_fcs_qo_os,DMOS_qo,fc_qo_os)
	call getfc(sinth,costh,Ncoeff_qo_oa,fitted_fc_coeff_qo_oa,stride_arr_qo_oa,fn_order_qo_oa,n_fcs_qo_oa,DMOA_qo,fc_qo_oa)
endsubroutine

!!****************************************************************************************#
!Compute dsdx
subroutine  getDsDx(X,dsdx)
    implicit none
    integer::i,j,k,istep
    real(8)::d1,d2,d3,d4
...
!****************************************************************************************#
!****************************************************************************************#
subroutine getPot(X,egpot,VrsEg)
	implicit none 
	real(8),intent(in):: X(0:Ncarts-1)
	...
	call scaleCoord(Sym_diff)
	!compute fitted force constants(fc)
	call getAllfc(sinth,costh,fc_quad_es,fc_quad_os,fc_quad_ea,fc_quad_oa,fc_qubic_es_gt5,fc_qubic_es_lt5,fc_qubic_es_lt2,fc_qubic_ea_gt5,fc_qubic_ea_lt5,fc_qubic_ea_lt2,fc_qubic_os_gt5,fc_qubic_os_lt5,fc_qubic_os_lt2,fc_qubic_oa_gt5,fc_qubic_oa_lt5,fc_qubic_oa_lt2,fc_quartic_es_gt5,fc_quartic_es_lt5,fc_quartic_es_lt2,fc_quartic_es_ltpt1,fc_quartic_ea_gt5,fc_quartic_ea_lt5,fc_quartic_ea_lt2,fc_quartic_ea_ltpt1, fc_quartic_os_gt5,fc_quartic_os_lt5,fc_quartic_os_lt2,fc_quartic_os_ltpt1,fc_quartic_oa_gt5,fc_quartic_oa_lt5,fc_quartic_oa_lt2,fc_quartic_oa_ltpt1,fc_qo_es,fc_qo_ea,fc_qo_os,fc_qo_oa,DMES_quad,DMES_gt5,DMES_qo,DMES_lt2,DMEA_quad,DMEA_gt5,DMEA_qo,DMEA_lt2,DMOS_quad,DMOS_gt5,DMOS_qo,DMOS_lt2,DMOA_quad,DMOA_gt5,DMOA_qo,DMOA_lt2) 
...
endsubroutine 
!****************************************************************************************#
subroutine getForce(X,dVdx,egpot)
	implicit none 
	real(8),intent(in) :: X(0:Ncarts-1)
	real(8) :: Xtmp(0:Ncarts-1)
