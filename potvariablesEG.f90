...
subroutine initializePotvars()
	...
	sym_mat      = 0.d0
	open(unit =13,file ="PotFitParamsEG/pot.param",status="old")
	...
	!enddo
	!Read_scale_factor
	open(unit =11,file ="PotFitParamsEG/scale_factor_eg_avtz.dat",status="old") 
	...
	open(unit=101,file='PotFitParamsEG/fitted_param_quad_'//trim(adjustl(fsuffix))//'es_fortran.dat',status='old')
	...
	fsuffix = trim(adjustl(mmaxchar))//'_'//trim(adjustl(nmaxchar))//'_'//trim(adjustl(lmaxchar))//'_'
	open(unit=102,file='PotFitParamsEG/fitted_param_qubic_gt5_'//trim(adjustl(fsuffix))//'es_fortran.dat',status='old')
	...
	fsuffix = trim(adjustl(mmaxchar))//'_'//trim(adjustl(nmaxchar))//'_'//trim(adjustl(lmaxchar))//'_'
	open(unit=103,file='PotFitParamsEG/fitted_param_qubic_lt5_'//trim(adjustl(fsuffix))//'es_fortran.dat',status='old')
	...
	fsuffix = trim(adjustl(mmaxchar))//'_'//trim(adjustl(nmaxchar))//'_'//trim(adjustl(lmaxchar))//'_'
	open(unit=104,file='PotFitParamsEG/fitted_param_qubic_lt2_'//trim(adjustl(fsuffix))//'es_fortran.dat',status='old')
	...
	fsuffix = trim(adjustl(mmaxchar))//'_'//trim(adjustl(nmaxchar))//'_'//trim(adjustl(lmaxchar))//'_'
	open(unit=105,file='PotFitParamsEG/fitted_param_quartic_gt5_'//trim(adjustl(fsuffix))//'es_fortran.dat',status='old')
	...
	fsuffix = trim(adjustl(mmaxchar))//'_'//trim(adjustl(nmaxchar))//'_'//trim(adjustl(lmaxchar))//'_'
	open(unit=106,file='PotFitParamsEG/fitted_param_quartic_lt5_'//trim(adjustl(fsuffix))//'es_fortran.dat',status='old')
	...
	fsuffix = trim(adjustl(mmaxchar))//'_'//trim(adjustl(nmaxchar))//'_'//trim(adjustl(lmaxchar))//'_'
	open(unit=107,file='PotFitParamsEG/fitted_param_quartic_lt2_'//trim(adjustl(fsuffix))//'es_fortran.dat',status='old')
	...
	fsuffix = trim(adjustl(mmaxchar))//'_'//trim(adjustl(nmaxchar))//'_'//trim(adjustl(lmaxchar))//'_'
	open(unit=108,file='PotFitParamsEG/fitted_param_quartic_ltpt1_es_fortran.dat',status='old')
	...
	fsuffix = trim(adjustl(mmaxchar))//'_'//trim(adjustl(nmaxchar))//'_'//trim(adjustl(lmaxchar))//'_'
	open(unit=109,file='PotFitParamsEG/fitted_param_quad_'//trim(adjustl(fsuffix))//'ea_fortran.dat',status='old')
	...
	fsuffix = trim(adjustl(mmaxchar))//'_'//trim(adjustl(nmaxchar))//'_'//trim(adjustl(lmaxchar))//'_'
	open(unit=110,file='PotFitParamsEG/fitted_param_qubic_gt5_'//trim(adjustl(fsuffix))//'ea_fortran.dat',status='old')
	...
	fsuffix = trim(adjustl(mmaxchar))//'_'//trim(adjustl(nmaxchar))//'_'//trim(adjustl(lmaxchar))//'_'
	open(unit=111,file='PotFitParamsEG/fitted_param_qubic_lt5_'//trim(adjustl(fsuffix))//'ea_fortran.dat',status='old')
	...
	fsuffix = trim(adjustl(mmaxchar))//'_'//trim(adjustl(nmaxchar))//'_'//trim(adjustl(lmaxchar))//'_'
	open(unit=112,file='PotFitParamsEG/fitted_param_qubic_lt2_'//trim(adjustl(fsuffix))//'ea_fortran.dat',status='old')
	...
	fsuffix = trim(adjustl(mmaxchar))//'_'//trim(adjustl(nmaxchar))//'_'//trim(adjustl(lmaxchar))//'_'
	open(unit=113,file='PotFitParamsEG/fitted_param_quartic_gt5_'//trim(adjustl(fsuffix))//'ea_fortran.dat',status='old')
	...
	fsuffix = trim(adjustl(mmaxchar))//'_'//trim(adjustl(nmaxchar))//'_'//trim(adjustl(lmaxchar))//'_'
	open(unit=114,file='PotFitParamsEG/fitted_param_quartic_lt5_'//trim(adjustl(fsuffix))//'ea_fortran.dat',status='old')
	...
	fsuffix = trim(adjustl(mmaxchar))//'_'//trim(adjustl(nmaxchar))//'_'//trim(adjustl(lmaxchar))//'_'
	open(unit=115,file='PotFitParamsEG/fitted_param_quartic_lt2_'//trim(adjustl(fsuffix))//'ea_fortran.dat',status='old')
	...
	open(unit=116,file='PotFitParamsEG/fitted_param_quartic_ltpt1_ea_fortran.dat',status='old')
    ...
    fsuffix = trim(adjustl(mmaxchar))//'_'//trim(adjustl(nmaxchar))//'_'//trim(adjustl(lmaxchar))//'_'
	open(unit=201,file='PotFitParamsEG/fitted_param_quad_'//trim(adjustl(fsuffix))//'os_fortran.dat',status='old')
    ...
    fsuffix = trim(adjustl(mmaxchar))//'_'//trim(adjustl(nmaxchar))//'_'//trim(adjustl(lmaxchar))//'_'
	open(unit=202,file='PotFitParamsEG/fitted_param_qubic_gt5_'//trim(adjustl(fsuffix))//'os_fortran.dat',status='old')
	...
	open(unit=203,file='PotFitParamsEG/fitted_param_qubic_lt5_'//trim(adjustl(fsuffix))//'os_fortran.dat',status='old')
    ...
    fsuffix = trim(adjustl(mmaxchar))//'_'//trim(adjustl(nmaxchar))//'_'//trim(adjustl(lmaxchar))//'_'
	open(unit=204,file='PotFitParamsEG/fitted_param_qubic_lt2_'//trim(adjustl(fsuffix))//'os_fortran.dat',status='old')
    ...
    fsuffix = trim(adjustl(mmaxchar))//'_'//trim(adjustl(nmaxchar))//'_'//trim(adjustl(lmaxchar))//'_'
	open(unit=205,file='PotFitParamsEG/fitted_param_quartic_gt5_'//trim(adjustl(fsuffix))//'os_fortran.dat',status='old')
    ...
    fsuffix = trim(adjustl(mmaxchar))//'_'//trim(adjustl(nmaxchar))//'_'//trim(adjustl(lmaxchar))//'_'
	open(unit=206,file='PotFitParamsEG/fitted_param_quartic_lt5_'//trim(adjustl(fsuffix))//'os_fortran.dat',status='old')
    ...
    fsuffix = trim(adjustl(mmaxchar))//'_'//trim(adjustl(nmaxchar))//'_'//trim(adjustl(lmaxchar))//'_'
	open(unit=207,file='PotFitParamsEG/fitted_param_quartic_lt2_'//trim(adjustl(fsuffix))//'os_fortran.dat',status='old')
	...
	open(unit=208,file='PotFitParamsEG/fitted_param_quartic_ltpt1_os_fortran.dat',status='old')
    ...
    fsuffix = trim(adjustl(mmaxchar))//'_'//trim(adjustl(nmaxchar))//'_'//trim(adjustl(lmaxchar))//'_'
	open(unit=209,file='PotFitParamsEG/fitted_param_quad_'//trim(adjustl(fsuffix))//'oa_fortran.dat',status='old')
    ...
    fsuffix = trim(adjustl(mmaxchar))//'_'//trim(adjustl(nmaxchar))//'_'//trim(adjustl(lmaxchar))//'_'
	open(unit=210,file='PotFitParamsEG/fitted_param_qubic_gt5_'//trim(adjustl(fsuffix))//'oa_fortran.dat',status='old')
    ...
    fsuffix = trim(adjustl(mmaxchar))//'_'//trim(adjustl(nmaxchar))//'_'//trim(adjustl(lmaxchar))//'_'
	open(unit=211,file='PotFitParamsEG/fitted_param_qubic_lt5_'//trim(adjustl(fsuffix))//'oa_fortran.dat',status='old')
    ...
    fsuffix = trim(adjustl(mmaxchar))//'_'//trim(adjustl(nmaxchar))//'_'//trim(adjustl(lmaxchar))//'_'
	open(unit=212,file='PotFitParamsEG/fitted_param_qubic_lt2_'//trim(adjustl(fsuffix))//'oa_fortran.dat',status='old')
    ...
    fsuffix = trim(adjustl(mmaxchar))//'_'//trim(adjustl(nmaxchar))//'_'//trim(adjustl(lmaxchar))//'_'
	open(unit=213,file='PotFitParamsEG/fitted_param_quartic_gt5_'//trim(adjustl(fsuffix))//'oa_fortran.dat',status='old')
    ...
    fsuffix = trim(adjustl(mmaxchar))//'_'//trim(adjustl(nmaxchar))//'_'//trim(adjustl(lmaxchar))//'_'
	open(unit=214,file='PotFitParamsEG/fitted_param_quartic_lt5_'//trim(adjustl(fsuffix))//'oa_fortran.dat',status='old')
    ...
    fsuffix = trim(adjustl(mmaxchar))//'_'//trim(adjustl(nmaxchar))//'_'//trim(adjustl(lmaxchar))//'_'
	open(unit=215,file='PotFitParamsEG/fitted_param_quartic_lt2_'//trim(adjustl(fsuffix))//'oa_fortran.dat',status='old')
	...
	open(unit=216,file='PotFitParamsEG/fitted_param_quartic_ltpt1_oa_fortran.dat',status='old')
    ...
    fsuffix = trim(adjustl(mmaxchar))//'_'//trim(adjustl(nmaxchar))//'_'//trim(adjustl(lmaxchar))//'_'
	open(unit=511,file='PotFitParamsEG/fitted_param_qo_'//trim(adjustl(fsuffix))//'es_fortran.dat',status='old')
    ...
    fsuffix = trim(adjustl(mmaxchar))//'_'//trim(adjustl(nmaxchar))//'_'//trim(adjustl(lmaxchar))//'_'
	open(unit=512,file='PotFitParamsEG/fitted_param_qo_'//trim(adjustl(fsuffix))//'ea_fortran.dat',status='old')
    ...
    fsuffix = trim(adjustl(mmaxchar))//'_'//trim(adjustl(nmaxchar))//'_'//trim(adjustl(lmaxchar))//'_'
	open(unit=513,file='PotFitParamsEG/fitted_param_qo_'//trim(adjustl(fsuffix))//'os_fortran.dat',status='old')
    ...
    fsuffix = trim(adjustl(mmaxchar))//'_'//trim(adjustl(nmaxchar))//'_'//trim(adjustl(lmaxchar))//'_'
	open(unit=514,file='PotFitParamsEG/fitted_param_qo_'//trim(adjustl(fsuffix))//'oa_fortran.dat',status='old')
	...
	call Read_Vt_coeff("PotFitParamsEG/pot_par_977.dat",fn_order_pot,Vt_coeff )
	!Vt_coeff = In Hartee
	!Symmetrized internal coordinate fit
	open(unit=302,file='PotFitParamsEG/eq_par_9_7_7_es_fortran.dat',status='old')
	...
	!Symmetrized internal coordinate fit
	open(unit=303,file='PotFitParamsEG/eq_par_9_7_7_ea_fortran.dat',status='old')
	...
	open(unit=304,file='PotFitParamsEG/eq_par_9_7_7_os_fortran.dat',status='old')
	...
	open(unit=305,file='PotFitParamsEG/eq_par_9_7_7_oa_fortran.dat',status='old')
	...
	call Read_atom_ind("PotFitParamsEG/atom_ind.dat",Natoms,atom_ind)
